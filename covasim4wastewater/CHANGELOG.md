...
- *GitHub info*: PR [1439](https://github.com/amath-idm/covasim/pull/1439)
...
- *GitHub info*: PR [1433](https://github.com/amath-idm/covasim/pull/1433)
...
- *GitHub info*: PR [1396](https://github.com/amath-idm/covasim/pull/1396)
...
- *GitHub info*: PR [1374](https://github.com/amath-idm/covasim/pull/1374)
...
- *GitHub info*: PR [1295](https://github.com/amath-idm/covasim/pull/1295)
...
- *GitHub info*: PR [1249](https://github.com/amath-idm/covasim/pull/1249)
...
- *GitHub info*: PR [1130](https://github.com/amath-idm/covasim/pull/1130)
...
- Refactored the NAb decay function to match the published version of [Khoury et al](https://www.nature.com/articles/s41591-021-01377-8) (the previous implementation matched the preprint).
...
- *GitHub info*: PR [1102](https://github.com/amath-idm/covasim/pull/1102)
...
- *GitHub info*: PR [1088](https://github.com/amath-idm/covasim/pull/1088)

### Version 3.0.5 (2021-05-26)

- Changed all reference to variants from `strain` to `variant`. For example, `cv.strain()` is now `cv.variant()`, `cv.Sim(strains=...)` is now `cv.Sim(variants=...)`, etc. See [this article](https://www.forbes.com/sites/jvchamary/2021/02/28/coronavirus-covid-variant-mutant-strain/?sh=4459cbc82241) for the rationale behind the change.
...
- *GitHub info*: PR [1069](https://github.com/amath-idm/covasim/pull/1069)
...
- *GitHub info*: PR [1058](https://github.com/amath-idm/covasim/pull/1058)
...
- *GitHub info*: PR [1047](https://github.com/amath-idm/covasim/pull/1047)
...
- *GitHub info*: PR [1020](https://github.com/amath-idm/covasim/pull/1020)
...
- *GitHub info*: PR [999](https://github.com/amath-idm/covasim/pull/999)
...
- *GitHub info*: PR [927](https://github.com/amath-idm/covasim/pull/927)
...
- *GitHub info*: PR [897](https://github.com/amath-idm/covasim/pull/897)
...
- Temporarily pinned `line_profiler` to version 3.1 due to [this issue](https://github.com/pyutils/line_profiler/issues/49).
...
- *GitHub info*: PR [887](https://github.com/amath-idm/covasim/pull/887)
...
- An extra tutorial has been added on "Deployment", covering how to use it with [Dask](https://dask.org/) and for using Covasim with interactive notebooks and websites.
...
- *GitHub info*: PR [859](https://github.com/amath-idm/covasim/pull/859)
...
- *GitHub info*: PR [854](https://github.com/amath-idm/covasim/pull/854)
...
- *GitHub info*: PR [788](https://github.com/amath-idm/covasim/pull/788)
...
- *GitHub info*: PR [779](https://github.com/amath-idm/covasim/pull/779)

### Version 2.0.1 (2021-01-31)

- Pinned `xlrd` version to 1.2.0 due to a bug introduced in the `2.0.1` version of `xlrd` (see [here](https://stackoverflow.com/questions/65250207/pandas-cannot-open-an-excel-xlsx-file) for details).
...
- *GitHub info*: PR [775](https://github.com/amath-idm/covasim/pull/775)
...
- **Webapp**: The webapp has been moved to a separate Python package, `covasim_webapp` (available [here](https://github.com/institutefordiseasemodeling/covasim_webapp)).
...
- The `sim.compute_r_eff()` error message now gives correct instructions (contributed by [Andrea Cattaneo](https://github.com/InstituteforDiseaseModeling/covasim/pull/295)).
...
- *GitHub info*: PRs [738](https://github.com/amath-idm/covasim/pull/738), [740](https://github.com/amath-idm/covasim/pull/740)
...
- *GitHub info*: PR [712](https://github.com/amath-idm/covasim/pull/712)
...
- *GitHub info*: PR [709](https://github.com/amath-idm/covasim/pull/709)

### Version 1.7.4 (2020-10-02)

- Refactored <span class="title-ref">cv.contact_tracing()</span> so that derived classes can extend individual parts of contact tracing without having to re-implement the entire intervention
- Moved <span class="title-ref">people.trace</span> to <span class="title-ref">contact_tracing</span> so that the tracing step can be extended via custom interventions
- *Regression information*: Custom interventions calling <span class="title-ref">people.trace</span> should inherit from <span class="title-ref">cv.contact_tracing</span> instead and use <span class="title-ref">contact_tracing.identify_contacts</span> and <span class="title-ref">contact_tracing.notify_contacts</span> to replace <span class="title-ref">people.trace</span>. In most cases however, it would be possible to overload one of the contact tracing steps rather than <span class="title-ref">contact_tracing.apply</span>, which thus eliminates the need to call <span class="title-ref">people.trace</span> entirely.
- *GitHub info*: PR [702](https://github.com/amath-idm/covasim/pull/702)
...
- *GitHub info*: PR [699](https://github.com/amath-idm/covasim/pull/699)
...
- *GitHub info*: PR [693](https://github.com/amath-idm/covasim/pull/693)
...
- *GitHub info*: PR [690](https://github.com/amath-idm/covasim/pull/690)
...
- *GitHub info*: PRs [669](https://github.com/amath-idm/covasim/pull/669), [677](https://github.com/amath-idm/covasim/pull/677), head `756e8eab`
...
- *GitHub info*: PR [664](https://github.com/amath-idm/covasim/pull/664), head `e902cdff`
...
- *GitHub info*: : PR [654](https://github.com/amath-idm/covasim/pull/654), head `d84b5f97`
...
- *GitHub info*: PR [624](https://github.com/amath-idm/covasim/pull/624), head `9041157f`
...
- *GitHub info*: PR [623](https://github.com/amath-idm/covasim/pull/623), head `aaa4d7c1`
...
- *GitHub info*: PR [596](https://github.com/amath-idm/covasim/pull/596), head `775cf358`
...
- *GitHub info*: PR [593](https://github.com/amath-idm/covasim/pull/593), head `4d8016fa`
...
- *GitHub info*: PR [588](https://github.com/amath-idm/covasim/pull/588), head `f7ef0fa5`
...
- *GitHub info*: PR [585](https://github.com/amath-idm/covasim/pull/585), head `4cabddc3`
...
- *GitHub info*: PR [582](https://github.com/amath-idm/covasim/pull/582), head `8bb8b82e`
...
- *GitHub info*: PR [573](https://github.com/amath-idm/covasim/pull/573), head `d84ffeff`
...
- *GitHub info*: PR [577](https://github.com/amath-idm/covasim/pull/577), head `5569b88a`
...
- *GitHub info*: PR [574](https://github.com/amath-idm/covasim/pull/574), head `a828d29b`
...
- Allowed <span class="title-ref">cv.load_data()</span>\` to accept non-time-series inputs.
...
- *GitHub info*: PR [569](https://github.com/amath-idm/covasim/pull/569), head `2dcf6ad8`
...
- *GitHub info*: PR [566](https://github.com/amath-idm/covasim/pull/566), head `19dcfdd7`
...
- *GitHub info*: PR [568](https://github.com/amath-idm/covasim/pull/568), head `8b157a26`
...
- *GitHub info*: PR [567](https://github.com/amath-idm/covasim/pull/567), head `d1b2bc40`
...
- *GitHub info*: PR [562](https://github.com/amath-idm/covasim/pull/562), head `a943bb9e`
...
- *GitHub info*: PR [561](https://github.com/amath-idm/covasim/pull/561), head `6c91a32c`
...
- *GitHub info*: PR [557](https://github.com/amath-idm/covasim/pull/557), head `32c5e1e3`
...
- *GitHub info*: PR [552](https://github.com/amath-idm/covasim/pull/552), head `3c1ca8b3`
...
- *GitHub info*: PR [551](https://github.com/amath-idm/covasim/pull/551), head `28bf02b5`
...
- *GitHub info*: PR [541](https://github.com/amath-idm/covasim/pull/541), head `07009eb9`
...
- *GitHub info*: PR [538](https://github.com/amath-idm/covasim/pull/538), head `9b2dbfba`
...
- *GitHub info*: PR [537](https://github.com/amath-idm/covasim/pull/537), head `451f4100`
...
- *GitHub info*: PR [531](https://github.com/amath-idm/covasim/pull/531), head `2d55c380`
...
- *GitHub info*: PR [510](https://github.com/amath-idm/covasim/pull/510), head `81261f90`
...
- *GitHub info*: PR [513](https://github.com/amath-idm/covasim/pull/513), head `2332c319`
...
- *GitHub info*: PR [502](https://github.com/amath-idm/covasim/pull/502), head `973801a6`
...
- *GitHub info*: PR [490](https://github.com/amath-idm/covasim/pull/490), head `1e08cc9a`
...
- *GitHub info*: PR [487](https://github.com/amath-idm/covasim/pull/487), head `9a6c23b`
...
- Added `ipywidgets` dependency since otherwise the webapp breaks due to a [bug](https://github.com/plotly/plotly.py/issues/2443) with the latest Plotly version (4.7).
...
- *GitHub info*: PR [482](https://github.com/amath-idm/covasim/pull/482)

### Version 0.31.0 (2020-05-05)

- Added age-susceptible odds ratios, and modified severe and critical progression probabilities. To compensate, default `beta` has been increased from 0.015 to 0.016. To restore previous behavior (which was based on the [Imperial paper](https://www.imperial.ac.uk/media/imperial-college/medicine/mrc-gida/2020-03-16-COVID19-Report-9.pdf)), set `beta=0.015` and set the following values in `sim.pars['prognoses']`:
...
- *GitHub info*: PR [480](https://github.com/amath-idm/covasim/pull/480), head `029585f`, previous head `c7171f8`
...
- Added [documentation](https://institutefordiseasemodeling.github.io/covasim-docs/).
